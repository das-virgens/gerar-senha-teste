        ...
        <div class="container">
            ...
            <section>
              ...
              <button class="itemCard" id="joseVicenteCheck" style="filter: saturate(100%) opacity(100%); cursor: pointer;">
                  <div class="profileImage"><img class="imagemCoord" src="images/antonio.png"><div class="mascara"></div></div>
                  <div id='infoCard'><h2 class="joseVicente-titulo">Antonio Jorge</h2>
